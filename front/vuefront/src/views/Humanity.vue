<template>
	<div class="humanity">
		<div style="position: absolute; top: 90px; right: 0px; left: 0px; bottom: 0px; overflow-y: auto;">
			<div class="humanityy" v-for="(item,index) in humanityy" :key="index" style="width: 375px; box-shadow: 5px 5px 5px rgb(179, 179, 179);">
				<router-link :to="'/detahum/'+item.id">
